# Google Cloud Client Libraries for Swift - Workload Manager API
...
Add `swift-google-cloud-workloadmanager-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-workloadmanager-v1.git --from 0.1.0-preview
```

Then add `GoogleCloudWorkloadManagerV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudWorkloadManagerV1 <target-name> --package swift-google-cloud-workloadmanager-v1
```
